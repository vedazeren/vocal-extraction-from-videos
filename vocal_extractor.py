...
parser = argparse.ArgumentParser(description = 'Create vocal-only downloadable YouTube videos')
parser.add_argument('-l','--link', type=str,  metavar='', required=True,help='Link to the YouTube video')
parser.add_argument('-fn','--filename', type=str, help='Give a filename to your output video')
...
if __name__ == '__main__':
    extract_vocals(args.link, args.filename)
